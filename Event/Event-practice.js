...
*/
document.getElementsByTagName('button')[0].onclick = function buttonEventHandler() {
    alert("Ai apasat pe buton!");
};
...
*/
document.getElementsByTagName('input')[0].onchange = function textInputEventHandler() {
...
const cameleonEventHandler = () => {
    document.getElementsByTagName("p")[0].style.color = randomColors();
};

document.getElementsByTagName("input")[0].addEventListener("keydown", cameleonEventHandler);
